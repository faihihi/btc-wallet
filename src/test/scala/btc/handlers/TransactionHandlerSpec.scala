...
class TransactionHandlerSpec
  ...
  val transactionHandler = new TransactionHandler(mockDbRepo, mockValidators)
  ...
  "saveTransaction" should {
    "return response correctly" in {
      ...
      transactionHandler.saveTransaction(saveTransactionRequest).map {
        response =>
          {
  ...
  "getTransactionHistories" should {
    "return response correctly" in {
      ...
      transactionHandler.getTransactionHistories(getHistoriesRequest).map {
        response =>
          {
